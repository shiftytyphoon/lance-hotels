      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          <h2 className="font-serif text-4xl md:text-5xl lg:text-6xl text-white leading-[1.1] tracking-[-0.02em] mb-6">
            <span className="italic">Start your first</span>
            <br />
            <span className="italic text-white/40">outbound campaign</span>
          </h2>

          <p className="font-sans text-lg text-white/50 mb-10 max-w-lg mx-auto">
            See how Lance drives results with proactive, personalized outreach.
          </p>
