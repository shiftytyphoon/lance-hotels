  ...
  return (
    <section className="py-24 md:py-32 px-6 lg:px-12 bg-[#0a0a0a]">
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          Let Lance handle the everyday conversations that keep your policyholders protected, while your team focuses on complex claims and building relationships.
        </motion.p>
      </div>
    </section>
  )
