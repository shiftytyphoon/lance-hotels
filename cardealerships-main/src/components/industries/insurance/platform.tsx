...
const platformFeatures = [
  {
    ...
    description: "Built for insurance regulations with audit trails, data retention policies, and state-specific compliance requirements.",
  },
  {
    icon: BarChart3,
    title: "Claims analytics",
    description: "Track resolution times, identify bottlenecks, and optimize your claims process with real-time insights.",
  },
  {
    icon: Zap,
    title: "Rapid deployment",
    description: "Go live in two weeks with pre-built insurance workflows and integrations with major policy admin systems.",
  },
]
        ...
        >
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16">
            <h2 className="font-serif text-4xl md:text-5xl lg:text-6xl text-white leading-[1.1] tracking-[-0.02em]">
              ...
              <br />
              <span className="italic text-white/40">insurance</span>
            </h2>

            <p className="font-sans text-white/60 leading-relaxed lg:pt-4">
              Deploy AI that understands insurance—from claims terminology to compliance requirements. Lance integrates with your existing systems and scales with your book of business.
            </p>
          </div>
        </motion.div>
          ...
          <div className="relative rounded-3xl overflow-hidden bg-gradient-to-br from-[#111] to-[#0a0a0a] border border-white/10 p-8 lg:p-12">
            ...
            <div className="relative z-10">
              <div className="text-center mb-12">
                ...
                <p className="font-sans text-white/50 max-w-lg mx-auto">Connect Lance to your policy admin and claims systems.</p>
              </div>

              <div className="flex flex-wrap justify-center items-center gap-8 md:gap-12">
                {["Guidewire", "Duck Creek", "Salesforce", "ServiceNow", "Genesys", "Five9"].map((integration) => (
                  <div
                    key={integration}
