...
import { ChevronDown, FileText, Shield, Clock, HeadphonesIcon } from "lucide-react"

const features = [
  {
    id: "claims",
    title: "Claims intake & status",
    icon: FileText,
    description: "Automate first notice of loss, gather claim details, and provide real-time status updates without hold times.",
  },
  {
    id: "policy",
    title: "Policy questions",
    icon: Shield,
    description: "Answer coverage questions, explain deductibles, and help customers understand their policies instantly.",
  },
  {
    id: "renewals",
    title: "Renewals & payments",
    icon: Clock,
    description: "Process payments, send renewal reminders, and handle billing inquiries automatically.",
  },
  {
    id: "routing",
    title: "Smart agent routing",
    icon: HeadphonesIcon,
    description: "Route complex claims and sensitive situations to the right specialist with full context.",
  },
]

export function Features() {
  const [openFeature, setOpenFeature] = useState("claims")
        ...
        <div className="relative z-10 px-6 lg:px-12 xl:px-20 py-20 lg:py-32">
          ...
          >
            ...
            <h2 className="font-serif text-5xl md:text-6xl lg:text-7xl text-white leading-[1.1] tracking-[-0.02em]">
              <span className="italic">Streamlined</span>
              <br />
              <span className="italic text-white/40">claims experience</span>
            </h2>
          </motion.div>
          ...
          >
            Our AI handles claims intake, policy questions, and routine service requests with empathy and accuracy—24/7.
          </motion.p>
            ...
            <div className="w-full max-w-sm bg-[#1a1a1a]/90 backdrop-blur-xl rounded-[2.5rem] border border-white/10 shadow-2xl overflow-hidden">
              ...
              <div className="p-6">
                ...
                <div className="text-center mb-8">
                  ...
                  <div className="font-sans text-lg text-white">SafeGuard Insurance</div>
                  <div className="font-mono text-xs text-white/40 mt-1">Claims Assistant</div>
                  <motion.div
                    className="font-mono text-xs text-green-400 mt-2"
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex gap-3">
                    <div className="w-7 h-7 rounded-full bg-white/10 flex items-center justify-center shrink-0">
                      <span className="text-[10px] font-sans text-white/60">M</span>
                    </div>
                    <div className="bg-white/5 rounded-2xl rounded-tl-none px-4 py-3 max-w-[85%]">
                      <p className="font-sans text-sm text-white/80">
                        I was in a fender bender. How do I file a claim?
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3 justify-end">
                    <div className="bg-orange-500/20 border border-orange-500/30 rounded-2xl rounded-tr-none px-4 py-3 max-w-[85%]">
                      <p className="font-sans text-sm text-white/90">
                        I'm sorry to hear that. I'll help you file your claim right now. First, is everyone safe and okay?
                      </p>
                    </div>
