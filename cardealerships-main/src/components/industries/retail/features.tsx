...
import { ChevronDown, ShoppingBag, Package, RotateCcw, MessageSquare } from "lucide-react"
...
const features = [
  {
    ...
    icon: ShoppingBag,
    description: "Track orders, update shipping info, and resolve delivery issues instantly with real-time integrations to your OMS.",
  },
  {
    id: "products",
    title: "Product recommendations",
    icon: Package,
    description: "Personalized suggestions based on purchase history, browsing behavior, and customer preferences.",
  },
  {
    id: "returns",
    title: "Returns & exchanges",
    icon: RotateCcw,
    description: "Process returns, initiate exchanges, and handle refunds seamlessly while maintaining customer satisfaction.",
  },
  {
    id: "support",
    title: "Proactive outreach",
    icon: MessageSquare,
    description: "Re-engage customers with personalized follow-ups, back-in-stock alerts, and loyalty rewards notifications.",
  },
]

export function Features() {
  const [openFeature, setOpenFeature] = useState("orders")
        ...
        <div className="relative z-10 px-6 lg:px-12 xl:px-20 py-20 lg:py-32">
          ...
          >
            ...
            <h2 className="font-serif text-5xl md:text-6xl lg:text-7xl text-white leading-[1.1] tracking-[-0.02em]">
              ...
              <br />
              <span className="italic text-white/40">support</span>
            </h2>
          </motion.div>
          ...
          >
            Our AI handles every customer request with personalized, on-brand responses that feel human and drive loyalty.
          </motion.p>
            ...
            <div className="w-full max-w-sm bg-[#1a1a1a]/90 backdrop-blur-xl rounded-[2.5rem] border border-white/10 shadow-2xl overflow-hidden">
              ...
              <div className="p-6">
                ...
                <div className="text-center mb-8">
                  ...
                  <div className="font-sans text-lg text-white">Allbirds Support</div>
                  <div className="font-mono text-xs text-white/40 mt-1">AI Assistant</div>
                  <motion.div
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex gap-3">
                    <div className="w-7 h-7 rounded-full bg-white/10 flex items-center justify-center shrink-0">
                      <span className="text-[10px] font-sans text-white/60">S</span>
                    </div>
                  ...
                  <div className="flex gap-3 justify-end">
                    <div className="bg-orange-500/20 border border-orange-500/30 rounded-2xl rounded-tr-none px-4 py-3 max-w-[85%]">
                      <p className="font-sans text-sm text-white/90">
                        I found your order - it's out for delivery today and will arrive by 5 PM. I've sent tracking to your email!
                      </p>
                    </div>
